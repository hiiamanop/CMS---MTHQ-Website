                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Tambah Program Keamanan</h6>
                        </div>
                    </div>

                    <div class="card-body pb-2">
                        <form action="{{ route('program_keamanan.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="input-group input-group-outline mb-3">
                                <select name="tipe_konten" id="tipe_konten" class="form-control @error('tipe_konten') is-invalid @enderror" onchange="toggleKontenFields()">
                            ...
                            <a href="{{ route('program_keamanan.index') }}" class="btn btn-secondary">Kembali</a>
                        </form>
                    </div>
                </div>
            </div>
