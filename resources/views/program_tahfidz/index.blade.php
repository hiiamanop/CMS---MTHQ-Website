                ...
                <div class="card my-4">
                    ...
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-0">
                            <a href="{{ route('program_tahfidz.create') }}" class="btn btn-primary btn-sm float-end me-3">Tambah Program</a>
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-xs font-weight-bold mb-0 text-center">{{ $programTahfidz->nama_attribute }}</td>

                                        <td class="text-xs font-weight-bold mb-0 text-center">{{ $programTahfidz->keterangan }}</td>
