                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Daftar Attribute Program Tahfidz</h6>
                            <a href="{{ route('program_tahfidz.create') }}" class="btn btn-primary btn-sm float-end mx-3">Tambah Attribute</a>
                        </div>
                    </div>
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-xs font-weight-bold text-center">{{ $programTahfidz->nama_attribute }}</td>
                                        <td class="text-xs font-weight-bold text-center">
