            ...
            <div class="col-12">
                <div class="card my-4">
                    ...
                    <div class="card-body pb-2">
                        <!-- Form untuk menambah data program tahfidz -->
                        <form action="{{ route('program_tahfidz.store') }}" method="POST">
                            @csrf
                            ...
                            <a href="{{ route('program_tahfidz.index') }}" class="btn btn-secondary">Kembali</a>
                        </form>
