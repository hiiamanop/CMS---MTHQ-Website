                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Tambah Program Ekstrakurikuler</h6>
                        </div>
                    </div>

                    <div class="card-body pb-2">
                        <form action="{{ route('program_ekstrakurikuler.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <a href="{{ route('program_ekstrakurikuler.index') }}" class="btn btn-secondary">Kembali</a>
                        </form>
                    </div>
                </div>
            </div>
